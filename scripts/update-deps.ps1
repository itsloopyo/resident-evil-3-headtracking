...
# including RE3. We deliberately vendor the universal asset, NOT the per-game
# RE3.zip nightly: the per-game zip bundles VR runtime DLLs (openvr_api.dll,
