...
# RE3.zip. Vendored zip is the install-time source of truth, so this is a
...
# REFramework is per-game: each nightly publishes RE9.zip, RE3.zip, RE4.zip ...
