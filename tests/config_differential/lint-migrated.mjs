...
// gives, which the lint reports because a committed file holds `default` there: that rule is for
// the committed file, so it is the one problem a migrated file may have.
